...
function LandEdit() {
  ...
  const [streetFront, setStreetFront] = useState(editParanomaData.streetFront);
  const [terrainType, SetTerrainType] = useState(editParanomaData.terrainType);
